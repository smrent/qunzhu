<?php
	...
	//echo "from:".$from;
	//exit;
	$headtitle="区块链帮助-群组详情-W".$house_rent_id;
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<header>
    ...
    <div class="nav-btn nav-return">
        ...
        <?php 
         if($from=="houseSeek"){
        	echo " <a href='../inh.php' style='float:left;'>";
        }else if($from=="houseSeek_info"){//UC等分享
        	if($house_rent_id_houseSeek_info==""){
        		echo " <a href='./inh.php' style='float:left;'>";
        	}else{
        		$href="inh_info.php?house_rent_id=$house_rent_id_houseSeek_info&from=houseSeek_info";
  ...
  <!--<a href="../pages/rent_info.html" class="content-box">-->
    ...
    <?php
		...
		while ($row = $rst->fetch_array(MYSQLI_ASSOC)){
			...
			//echo "<img class='room-pic' src='".$headimg."' alt='' style='width:100%;height:100%;'>";
			if($pic_link==""){
				echo "<a class='content-box' ddd='$headimg'>";
				echo "<div class='image-pic-float' alt='' style='background-image: url(".$headimg.");'>";//padding-bottom: 30%;background-size: 100% 100%;float: left;width: 30%;
				echo "</div>";
			}else{
			...
			//Get user rent house numbers from table house_seek
			...
			//双tab
			echo "<div id='tab-bar' class='tab-bar'><a href='#' data-content='tab-content-1' class='tab-btn active'>群组信息</a><a href='#' data-content='tab-content-2' class='tab-btn'>联系方式</a></div>";
			echo "<a style='display: inline-block; height: 209px;' id='tab-content-1' class='content-box'>";
			...
			echo "</div>";
			echo "</a>";
			echo "<div style='display: none; height: 209px;' id='tab-content-2' class='owner-info'>";
			echo "<div class='room-desc float-left'>";
			echo "<ul>";
			echo "<br>";
			echo "<li>".$w_or_m."码：<span>".$contact."</span></li>";
			echo "<li>群主验证：<span>请联系微博<a style='color:blue;text-decoration:underline;' href='https://m.weibo.cn/u/6394107835'>区块链帮助</a></span></li>";
			echo "</ul>";
			echo "</div>";
			echo "</div>"; 
		}
