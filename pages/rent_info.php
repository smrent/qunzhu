<?php
	...
	//echo "from:".$from;
	//exit;
	$headtitle="区块链帮助-群组详情-V".$house_rent_id;
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<header>
    ...
    <div class="nav-btn nav-return">
    	<form id='frm' action="../php/search.php" method="get">
  ...
  <!--<a href="../pages/rent_info.html" class="content-box">-->
    ...
    <?php
		...
		while ($row = $rst->fetch_array(MYSQLI_ASSOC)){
			...
			$district=$district."/".$rent_type."/".$room_type;
			$time0=$row['addtime'];
			...
			echo "<span id='watcher'>V".$house_rent_id."</span>";//浏览量 改为ID 编号
			echo "</li>";
			...
			//$pos = strpos($price, 'b');
			echo "<i class='fa fa-thumbs-o-up' aria-hidden='true'></i>";
			echo "<span class='helped'>$helped</span>";
			echo "</li>";
			echo "</ul>";
			echo "</div>";
			echo "</div>";
			...
			echo "<li>表扬投诉：<span>请联系微博<a style='color:blue;text-decoration:underline;' href='https://m.weibo.cn/u/6394107835'>区块链帮助</a></span></li>";
			echo "</ul>";
			echo "</div>";
			echo "</div>"; 
		}
