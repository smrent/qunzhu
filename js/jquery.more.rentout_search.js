                    ...
                    $.each(this, function(key, value){
                    	  if(t.find('.'+key)) {
                    	  	...
                    	  	//alert(data);
 													...
 													price_get=obj1[0].price_get;
 													//result_get0=result_get[0];
 													//alert(rent_type_get);
 													//alert(keyword_get);
                    	  	if(key == 'pic-wrapper-float'){//房源照片 用户头像
                    	  		...
                    	  		//alert(key);
                    	  		//var href="rent_info.php?house_rent_id="+value+"&from=rentout_search"+"&keyword_get="+keyword_get+"&rent_type_get="+rent_type_get+"&district_get="+district_get+"&subway_get="+subway_get+"&room_type_get="+room_type_get+"&price_get="+price_get";
                    	  		var href="../pages/rent_info.php?house_rent_id="+value+"&from=rentout_search"+"&keyword_get="+keyword_get+"&rent_type_get="+rent_type_get+"&district_get="+district_get+"&subway_get="+subway_get+"&room_type_get="+room_type_get+"&price_get="+price_get;
                    	  		//var href="rent_info.php?house_rent_id="+value+"&from=rentout_search"+"&keyword_get="+keyword_get+"&rent_type_get="+rent_type_get+"&district_get="+district_get;
	                    	  	if(t.find('.'+key)) t.find('.'+key).attr('href',href);
	                    	  }else if(key == 'title'){//出租详情链接
                    	  		//alert(value);
                    	  		if(value==""){
                    	  			if(t.find('.'+key)) t.find('.'+key).hide();
                    	  		}else{
...
//                    	  		if(value == "暂无"){
//                    	  			//var innerhtml="1 星期前";
//                    	  			if(t.find('.'+key)) t.find('.'+key).html(time1);
//                    	  		}else{
//                    	  			if(t.find('.'+key)) t.find('.'+key).html(value);
//                    	  		}
                    	  		//if(t.find('.'+key)) t.find('.'+key).html(value);
